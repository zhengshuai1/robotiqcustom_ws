...
class Transform(object):
    ...
    def to_list(self):
        return np.r_[self.translation, self.rotation.as_quat()]
    ...
    @classmethod
    def from_matrix_list(cls, m, list):
        """Initialize from a 4x4 matrix."""
        rotation = Rotation.from_dcm(m)
        translation = list
        return cls(rotation, translation)
    ...
    def from_list(cls, list):
        rotation = Rotation.from_quat(list[3:])
        translation = list[:3]
        return cls(rotation, translation)

    @classmethod
    def from_euler_list(cls, list):
        rotation = Rotation.from_euler('zyx', list[3:])
        translation = list[:3]
        return cls(rotation, translation)
    ...
    def look_at(cls, eye, center, up):
        ...
        forward = center - eye  # camera center
